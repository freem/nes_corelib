; EKROM: (128,256,512,1024)KB PRG-ROM + 8KB PRG-RAM + (128,256,512,1024)KB CHR-ROM
; http://bootgod.dyndns.org:7777/search.php?keywords=EKROM&kwtype=pcb
;------------------------------------------------------------------------------;
...
; EKROM mirroring is controlled by MMC5.
		  ; %0000 = Horizontal
		  ; %0001 = Vertical
MIRRORING = %0001

; Mapper 005 (MMC5 - EKROM) iNES v1.0 header
	.byte "NES",$1A
