; TKROM: (128,256,512)KB PRG-ROM + 8KB PRG-RAM + (128,256)KB CHR-ROM
; http://bootgod.dyndns.org:7777/search.php?keywords=TKROM&kwtype=pcb
;------------------------------------------------------------------------------;
...
; TKROM mirroring is controlled by MMC3.
		  ; %0000 = Horizontal
		  ; %0001 = Vertical
MIRRORING = %0001

; Mapper 004 (MMC3 - TKROM) iNES v1.0 header
	.byte "NES",$1A
